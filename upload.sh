...
echo "\n ---- 开始打包二进制文件 ---- \n"
pod package ./$PROJECT_NAME.podspec --exclude-deps --force --no-mangle --spec-sources=https://github.com/CocoaPods/Specs.git,https://code.aliyun.com/mobile-sdk/XCSpecs.git
eval $PACKAGE
